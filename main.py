...
#tipe data datetime untuk kolom order_date dan ship_date
df['order_date'] = pd.to_datetime(df['order_date'])
df['ship_date'] = pd.to_datetime(df['ship_date'])

#kita extract year digit dari kolom order_date
df['order_year'] = df['order_date'].dt.year

#CURR_YEAR —> tahun terakhir pada dataframe
